...
export default function Server(app: express, bottleneck: Bottleneck, { customerioSiteId, customerioApiKey, idMapping }: any) {
  app.use(ApplyAgent(bottleneck, customerioSiteId, customerioApiKey, idMapping));
